...
vim.keymap.set("n", "<leader>oo", function()
    require("omp").open()
end, { silent = true, desc = "Open OMP chat" })
vim.keymap.set("n", "<leader>oa", function()
    require("omp").attach_current()
end, { silent = true, desc = "Attach current file to OMP" })
vim.keymap.set("x", "<leader>oa", function()
    require("omp").attach_selection()
end, { silent = true, desc = "Attach selection to OMP" })
